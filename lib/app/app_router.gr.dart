...
import 'package:vibeat/features/favorite/data/models/beat_model.dart' as _i19;
...
class FilterBpmRoute extends _i23.PageRouteInfo<void> {
  ...
  static _i23.PageInfo page = _i23.PageInfo(
    name,
    builder: (data) {
      return const _i6.FilterBpmScreen();
    },
  );
}
...
class PlaylistMoodRoute extends _i23.PageRouteInfo<PlaylistMoodRouteArgs> {
  ...
  static _i23.PageInfo page = _i23.PageInfo(
    ...
    builder: (data) {
      ...
      return _i16.PlaylistMoodScreen(key: args.key, mood: args.mood);
    },
  );
}
...
class PlaylistRoute extends _i23.PageRouteInfo<PlaylistRouteArgs> {
  PlaylistRoute({
    ...
    required List<_i19.BeatModel> beats,
    List<_i23.PageRouteInfo>? children,
  }) : super(
          PlaylistRoute.name,
...
class PlaylistRouteArgs {
  ...
  final List<_i19.BeatModel> beats;
